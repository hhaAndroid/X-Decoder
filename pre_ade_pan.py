...
if __name__ == "__main__":
    dataset_dir = '/home/PJLAB/huanghaian/dataset/'
    ...
    for name, dirname in [("val", "validation")]:
        ...
        # json config
        config_file = dataset_dir+"ADEChallengeData2016/imgCatIds.json"
        with open(config_file) as f:
            config = json.load(f)

        # load catid mapping
        mapping_file = dataset_dir+"ADEChallengeData2016/categoryMapping.txt"
